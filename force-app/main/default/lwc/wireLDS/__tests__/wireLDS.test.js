    ...
    describe("getRecord @wire data", () => {
        it("renders contact details", () => {
            ...
            return Promise.resolve().then(() => {
                ...
                expect(nameElement.textContent).toBe("Account Name: " + mockGetRecord.fields.Name.value);
                const industryElement = element.shadowRoot.querySelector("p.accountIndustry");
                expect(industryElement.textContent).toBe("Industry: " + mockGetRecord.fields.Industry.value);
                const phoneElement = element.shadowRoot.querySelector("p.accountPhone");
                expect(phoneElement.textContent).toBe("Phone: " + mockGetRecord.fields.Phone.value);
                const ownerElement = element.shadowRoot.querySelector("p.accountOwner");
                expect(ownerElement.textContent).toBe("Owner: " + mockGetRecord.fields.Owner.displayValue);
            });
        });
    });
